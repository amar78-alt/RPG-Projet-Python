...
class Monstre(Creature):
    def __init__(self, nom, description, pv, attaque, defense, type_degats, resistances):
        # On appelle le constructeur de la classe parente Creature
        super().__init__(nom, description, pv, defense, type_degats)
        self.attaque = attaque
        self.resistances = resistances

    def appliquer_resistance(self, degats, type_degats):
        # Si le type de l'attaque est dans les résistances, les dégâts sont divisés par 2
...
monstres_disponibles = [dragon, troll, gobelin, squelette]